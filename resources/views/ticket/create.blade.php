...
@section('content')
    <x-card>
        <form method="post" action="{{ route('station.store') }}" class="" id="submit-form">
            @csrf
            @method('post')
            ...
            <div class="form-group">
                ...
                <x-text-input id="location" name="location" type="text" class="tw-mt-1 tw-block tw-w-full location" :value="old('location')" />
